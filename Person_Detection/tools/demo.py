...
NETS = {'vgg16': ('vgg16_faster_rcnn_iter_65000.ckpt',),'res101': ('res101_faster_rcnn_iter_110000.ckpt',)}
...
def demo(sess, net, image_name):
    ...
    for cls_ind, cls in enumerate(CLASSES[1:]):
        ...
        dets = dets[keep, :]
        if str(cls)=='person':
            person_count = vis_detections(im, cls, dets, thresh=CONF_THRESH)
            ...
            if person_count > 0:
                ...
                f.close()
                #logging.info('Image ' + str(image_name) + ' have ' + str(person_count)) 
            # if person_count > 2:
            #     #sendmessage("WARNING",str(image_name))
            #     sendmessage2(str(image_name) + " has " + str(person_count) + " Person.")
